...
void draw() {
  ...
  if(pantalla == "pantalla0"){ //Pantalla de INICIO
    ...
    fill(#82c6c6);
    text("Pulsa ESPACIO para seguir",340,490);
    ...
    text(" Pedirle ayuda\n       al rio",455,270);
    fill(#82c6c6);
    text("Pulsa IZQUIERDA o DERECHA",310,490);
    ...
    fill(#82c6c6);
    text("Pulsa R para volver al inicio",325,490);
  ...
  }else if(pantalla == "pantalla20"){ //Pantalla de CRÉDITOS
    image(imagen[20],0,0);
    fill(0);
    textSize(25);
